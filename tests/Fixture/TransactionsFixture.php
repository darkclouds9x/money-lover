...
class TransactionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'done_date' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'transactions_ibfk_1' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['categories', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'parent' => 1,
            'done_date' => 1,
            'created' => '2015-07-29 01:38:31',
            'modified' => '2015-07-29 01:38:31',
            'deleted' => '2015-07-29',
            'status' => 1
        ],
    ];
